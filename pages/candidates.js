...
import BrandSlider from "../components/slider/BrandSlider"; //OK
import { useEffect, useState } from "react";
import data from "../public/static/candidates"; //NOTE JSON

import MetaData from "../components/Layout/MetaData";
import { useDispatch, useSelector } from "react-redux";
import { getCandidates } from "../actions/candidatesAction";
...
export default function Candidates() {
  ...
  return (
    ...
    <div className="jobbox-dashboard">
      <Layout breadcrumbTitle="Candidates" breadcrumbActive="Candidates">
