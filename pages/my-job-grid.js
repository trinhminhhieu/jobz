...
import data from "../public/static/myjob";
                      ...
                      <div className="col-xl-6 col-lg-7 text-lg-end mt-sm-15">
                        <div className="d-flex justify-content-end">
                          ...
                          <div className="box-view-type">
                            ...
                            >
                              <img
                                src="dashboard/assets/imgs/template/icons/icon-list.svg"
                                alt="jobBox"
                              />
                            </a>
                            <a
                            ...
                            >
                              <img
                                src="dashboard/assets/imgs/template/icons/icon-grid-hover.svg"
                                alt="jobBox"
                              />
                            </a>
                          </div>
