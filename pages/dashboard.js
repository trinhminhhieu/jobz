...
export default function Dashboard() {
  return (
    //NOTE <div className="jobbox-dashboard"> new
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image">
                    <img
                      src="dashboard/assets/imgs/page/dashboard/computer.svg"
                      alt="jobBox"
                    />
                  </div>
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image">
                    {" "}
                    <img
                      src="dashboard/assets/imgs/page/dashboard/bank.svg"
                      alt="jobBox"
                    />
                  </div>
                  <div className="card-info">
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image">
                    {" "}
                    <img
                      src="dashboard/assets/imgs/page/dashboard/lamp.svg"
                      alt="jobBox"
                    />
                  </div>
                  <div className="card-info">
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image">
                    {" "}
                    <img
                      src="dashboard/assets/imgs/page/dashboard/headphone.svg"
                      alt="jobBox"
                    />
                  </div>
                  <div className="card-info">
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image">
                    {" "}
                    <img
                      src="dashboard/assets/imgs/page/dashboard/look.svg"
                      alt="jobBox"
                    />
                  </div>
                  <div className="card-info">
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image">
                    {" "}
                    <img
                      src="dashboard/assets/imgs/page/dashboard/open-file.svg"
                      alt="jobBox"
                    />
                  </div>
                  <div className="card-info">
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image">
                    {" "}
                    <img
                      src="dashboard/assets/imgs/page/dashboard/doc.svg"
                      alt="jobBox"
                    />
                  </div>
                  <div className="card-info">
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image">
                    {" "}
                    <img
                      src="dashboard/assets/imgs/page/dashboard/man.svg"
                      alt="jobBox"
                    />
                  </div>
                  <div className="card-info">
                  ...
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image">
                        {" "}
                        <img
                          src="dashboard/assets/imgs/page/dashboard/img1.png"
                          alt="jobBox"
                        />
                      </div>
                      <div className="card-title">
                  ...
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image">
                        {" "}
                        <img
                          src="dashboard/assets/imgs/page/dashboard/img2.png"
                          alt="jobBox"
                        />
                      </div>
                      <div className="card-title">
                  ...
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image">
                        {" "}
                        <img
                          src="dashboard/assets/imgs/page/dashboard/img3.png"
                          alt="jobBox"
                        />
                      </div>
                      <div className="card-title">
                  ...
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image">
                        {" "}
                        <img
                          src="dashboard/assets/imgs/page/dashboard/img4.png"
                          alt="jobBox"
                        />
                      </div>
                      <div className="card-title">
                  ...
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image">
                        {" "}
                        <img
                          src="dashboard/assets/imgs/page/dashboard/img5.png"
                          alt="jobBox"
                        />
                      </div>
                      <div className="card-title">
                ...
                <div className="panel-body">
                  <div className="card-style-3 hover-up">
                    <div className="card-image online">
                      <img
                        src="dashboard/assets/imgs/page/dashboard/avata1.png"
                        alt="jobBox"
                      />
                    </div>
                    <div className="card-title">
                    ...
                    <div className="card-rating">
                      <img
                        src="dashboard/assets/imgs/page/dashboard/star.svg"
                        alt="jobBox"
                      />{" "}
                      <img
                        src="dashboard/assets/imgs/page/dashboard/star.svg"
                  ...
                  <div className="card-style-3 hover-up">
                    <div className="card-image online">
                      <img
                        src="dashboard/assets/imgs/page/dashboard/avata2.png"
                        alt="jobBox"
                      />
                    </div>
                    <div className="card-title">
                  ...
                  <div className="card-style-3 hover-up">
                    <div className="card-image online">
                      <img
                        src="dashboard/assets/imgs/page/dashboard/avata3.png"
                        alt="jobBox"
                      />
                    </div>
                    <div className="card-title">
                  ...
                  <div className="card-style-3 hover-up">
                    <div className="card-image online">
                      <img
                        src="dashboard/assets/imgs/page/dashboard/avata4.png"
                        alt="jobBox"
                      />
                    </div>
                    <div className="card-title">
                  ...
                  <div className="card-style-3 hover-up">
                    <div className="card-image online">
                      <img
                        src="dashboard/assets/imgs/page/dashboard/avata5.png"
                        alt="jobBox"
                      />
                    </div>
                    <div className="card-title">
                      ...
                      <div className="card-style-4 hover-up">
                        <div className="d-flex">
                          ...
                          <div className="card-title">
                            ...
                            />{" "}
                            <img
                              src="dashboard/assets/imgs/page/dashboard/star-none.svg"
                              alt="jobBox"
                            />
                            <img
                              src="dashboard/assets/imgs/page/dashboard/star-none.svg"
