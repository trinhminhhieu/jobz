...
import { getPostjob } from "../../actions/postjobAction";
...
const CategoryTab = () => {
  ...
  const { loading, postjob, postjobCount, error } = useSelector(
    (state) => state.postjob
  );
                ...
                >
                  <div className="card-grid-2 hover-up">
                    <div className="card-grid-2-image-left">
                      ...
                      <div className="right-info">
                        <Link legacyBehavior href="company-details">
                          <a className="name-job">HieuGroup</a>
                        </Link>
                    ...
                    <div className="card-block-info">
                      <h6>
                        <Link legacyBehavior href={`/postjob/${postjob._id}`}>
                          <a>{postjob.name}</a>
                        </Link>
                      </h6>
                      <div className="mt-5">
