...
export default function Header() {
  ...
  return (
    <>
      <header className={`header   test sticky-bar ${scroll ? "stick" : ""}`}>
            ...
            <div className="header-left">
              <div className="header-logo">
                <Link className="d-flex" href="/">
                  <img
                    alt="jobBox"
                    src="dashboard/assets/imgs/page/dashboard/logo.svg"
                  />
                </Link>
              </div>
            ...
            <div className="header-right">
              <div className="block-signin">
                ...
                <div className="member-login">
                  <img
                    alt=""
                    src="dashboard/assets/imgs/page/dashboard/profile.png"
                  />
                  <div className="info-member">
                    {" "}
                    <strong className="color-brand-1">Trinh Minh Hieu</strong>
